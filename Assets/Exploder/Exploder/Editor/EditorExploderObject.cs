...
public class EditorExploderObject : UnityEditor.Editor
{
    ...
    SerializedProperty fragmentPrefab;
    ...
    private void OnEnable()
    {
        ...
        fragmentParticlesTimeout = serializedObject.FindProperty("SFXOptions.ParticleTimeout");
        fragmentPrefab = serializedObject.FindProperty("FragmentPrefab");
...
//            EditorGUILayout.Space();
            ...
            change |= EditorExploderUtils.ObjectSelection<GameObject>("Fragment prefab", "Custom fragment prefab.", fragmentPrefab);
